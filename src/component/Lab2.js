        ...
        return (
          ...
          <section class="blog-post-area section-gap relative">
              <div class="container" style={{boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}}>
                  <div class="rows">
                  <div className="container"><h2 style={{margin: '20px 0'}}>Lab 2</h2></div>
                <div id="exTab2" className="container" >	
                  ...
                  <div className="tab-content "style={{padding: '0 10px'}} >
                    ...
                    <h4 style={{padding:'17px 0'}}><strong>1. Tạo ra một user scenario</strong></h4>
                    <h4 style={{paddingTop:'24px'}}><strong>2. Chọn 1 bước trong user scenario để thiết kế 1 form giao diện Web trên công cụ thiết kế đã chọn. Sau đó tạo ra file html tương ứng cho thiết kế này.</strong></h4>
                    <p>&nbsp;</p>
